  ...
  <div style="flex: 1;">
    <ul style="list-style-type: none; padding: 0; margin: 0;">
      ...
      <li style="display: flex; align-items: center; margin-bottom: 10px;">
        ...
        <span style="font-size: 20px; flex: 1; text-align: left;">Me gusta trabajar en equipo</span>
      </li>
      <li style="display: flex; align-items: center; margin-bottom: 10px;">
        <img src="https://img.icons8.com/color/32/000000/handshake.png" alt="Cooperación" style="margin-right: 15px;">
        <span style="font-size: 20px; flex: 1; text-align: left;">Siempre estoy dispuesto a cooperar con otros miembros del equipo</span>
      </li>
      <li style="display: flex; align-items: center;">
        <img src="https://img.icons8.com/color/32/000000/telescope.png" alt="Portafolio personal" style="margin-right: 15px;">
        <span style="font-size: 20px; flex: 1; text-align: left;">Actualmente estoy trabajando en mi portafolio personal</span>
      </li>
    </ul>
  </div>
